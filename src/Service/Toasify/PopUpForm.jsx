  ...
  return (
    <>
      <div className="container mx-auto py-20">
        ...
        <div
          className={`fixed  left-[-100px] top-10 flex h-full min-h-screen w-full items-center justify-center bg-dark/90 px-4 py-5 ${
        ...
        >
          <div
            ...
            className="w-full max-w-[570px] rounded-[20px]   text-center dark:bg-dark-2 md:px-[px] md:py-[60px]"
          >
          <div className="form ">
          <DetailForm/>
          </div>
