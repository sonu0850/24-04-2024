...
import { closeModal, tableData } from "../../Store/AuthSlice/authSlice";

// SignUp Using Formik for for form and Yup for Form Validation

const Details = () => {
  const editData = useSelector((state)=>state.authSlice.editData)
  ...
  return (
    <>
      <button onClick={()=>{dispatch(closeModal())}} className=" bg-slate-100 px-3">X</button>
      <div className="signup m-auto  md:flex md:justify-center md:items-center bg-black w-[800px]  text-white rounded-2xl ">
    

        <div className="form w44">
          ...
          <form
            ...
            className=" max-w-xl md:w-[800px]  p-4 w-full"
          >
